...
path = os.path.abspath(__name__).replace(".translator", "").replace(".", "/")
...
def translateCountryName(countryName, country, language):
    ...
    if countryName in dictionary[country.lower()]["countries"]:
        if dictionary[country.lower()]["countries"][countryName] == "ignore":
            return "ignore"
        return dictionary["general"]["countries"][dictionary[country.lower()]["countries"][countryName]]
    ...
    if countryTranslated == "ignore":
        return "ignore"
    return dictionary["general"]["countries"][countryTranslated]
